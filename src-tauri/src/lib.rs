...
use commands::{check_auth_state, complete_oauth, sign_out, start_oauth, validate_soundcloud_url, OAuthState};
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![start_oauth, complete_oauth, check_auth_state, sign_out, validate_soundcloud_url])
        .setup(|app| {
            app.handle().plugin(
