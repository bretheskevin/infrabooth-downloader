...
use commands::{
    ...
    get_app_data_path, get_artist_activity, get_artist_followers, get_artist_followings, get_artist_albums, get_artist_liked_tracks, get_artist_playlists, get_artist_profile,
