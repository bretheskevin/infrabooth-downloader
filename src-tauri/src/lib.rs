...
use commands::{
    ...
    get_app_data_path, get_artist_activity, get_artist_followers, get_artist_followings, get_artist_liked_tracks, get_artist_playlists, get_artist_profile,
    ...
    get_feature_flags, get_followed_artists, get_library_playlists, get_liked_tracks, get_log_path, get_notifications_page, get_owned_playlists_for_track,
    get_playlist_info, get_playlist_tracks, get_rekordbox_playlist_tree, get_release_tracks, get_selections, get_track_comments, get_track_info,
    get_unread_conversations_flag, get_unread_count, install_update, is_tls_verify_disabled, like_playlist, like_track, list_rekordbox_backups,
    list_rekordbox_playlists, mark_artist_releases_seen, mark_artist_seen, mark_conversation_read, mark_notifications_seen, open_in_firefox, quit_rekordbox,
    refresh_auth, remove_playlist_from_library_cache, remove_track_from_playlist, resolve_library_artwork, resolve_message_embed, resolve_playback_url,
...
pub fn run() {
    ...
    let builder = Builder::<tauri::Wry>::new()
        ...
        .commands(collect_commands![
            ...
            clear_library_cache,
            remove_playlist_from_library_cache,
