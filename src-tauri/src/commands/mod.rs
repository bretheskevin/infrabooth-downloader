...
pub use auth::{check_auth, check_firefox_installed, list_profiles, open_in_firefox, refresh_auth, sign_out};
...
pub mod artist;
pub use artist::{
    get_all_artist_tracks, get_artist_albums, get_artist_followers, get_artist_followings, get_artist_liked_tracks, get_artist_playlists, get_artist_profile,
    resolve_soundcloud_link, resolve_user,
};

pub mod comments;
pub use comments::{delete_comment, get_track_comments, post_comment};
