...
describe('SidebarNavItem', () => {
  ...
  it('should show active indicator bar when active', () => {
    const { container } = render(<SidebarNavItem {...defaultProps} active={true} />);
  ...
  it('should hide indicator bar when inactive', () => {
    const { container } = render(<SidebarNavItem {...defaultProps} active={false} />);
    const indicator = container.querySelector('[data-testid="active-indicator"]');
  ...
  it('should render dot badge', () => {
    const { container } = render(<SidebarNavItem {...defaultProps} badge="dot" />);
