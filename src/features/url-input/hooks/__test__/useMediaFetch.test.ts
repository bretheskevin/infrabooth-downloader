...
const mockPlaylist = {
  ...
  track_count: 5,
  tracks: [
    { id: 1, title: 'Track 1', user: { username: 'Artist1', avatar_url: null }, artwork_url: null, duration: 180000, permalink_url: 'https://soundcloud.com/artist1/track-1', waveform_url: null },
  ],
};
