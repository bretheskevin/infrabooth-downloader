...
- Selections now refresh automatically each day

### Changed

- Loading spinner on play/pause while a track loads

### Fixed

- Conversations with deleted users could fail to load
## [1.33.0] - 2026-07-29
...
- Control the app from your phone, set up in settings

### Fixed

- Couldn't download private tracks shared via link
- Download progress was hidden behind the player bar
## [1.30.0] - 2026-06-21
...
- Rekordbox export could fail in some cases
- Soft-deleted playlists showing in Rekordbox export
- Rekordbox root folder export mismatch
- Queue items overlapping in the player
...
- User profile previews in messages

## [1.25.0] - 2026-04-23

### Added

- Share playlists via direct message

### Fixed

- Track title overflowed in share dialog
